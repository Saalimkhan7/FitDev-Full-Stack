      ...
      <footer className="bg-white">
        <div className="container page-padding py-[10rem]">
          ...
          <div className="flex justify-between min620:flex-col min620:items-center min620:text-center min620:gap-[5rem] !text-left">
            ...
            <h1 className="text-black font-bold text-6xl">FitDev</h1>
              <p className="text-[15px] font-medium text-[#646464]">
              Connect with fellow coders who share your passion for fitness. Together, we grow stronger.
